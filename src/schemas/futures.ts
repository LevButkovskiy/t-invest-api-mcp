...
// Zod схема для валидации параметров инструмента getFutures
export const GetFuturesParamsSchema = z.object({
  limit: z
    .number()
    .min(1)
    .max(1000)
...
export type GetFuturesParams = z.infer<typeof GetFuturesParamsSchema>;

// Zod схема для валидации параметров инструмента getFutureBy
export const GetFutureByParamsSchema = z.object({
  id: z
    .string()
    .min(1)
...
export type GetFutureByParams = z.infer<typeof GetFutureByParamsSchema>;
